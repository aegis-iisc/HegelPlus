...
(*get a value from location n and put it to the location n, 
1. has commutative operations 
like copy.length and length.copy 
2. Shows inefficiency of CDCL
3. Inefficient syntactic contraints as regular expressions are insufficient for pruning the space

This example is same as Vector4*)
goal :  (n : int) -> 
        (m : int) -> 
        (a1 : ref vec) -> 
       State {\(h : heap).
