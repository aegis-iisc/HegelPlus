...
(*HighlightsIncompletenss due to semantic constraints, needs to create a copy*)
goal : (a1 : ref vec) -> 
       State {\(h : heap).
                  vdom (h, a1) = true /\ 
                  sel (h, num) == 1 
